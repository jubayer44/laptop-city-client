...
const CustomerReviews = () => {
  return (
    <section className="my-8">
      ...
      <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-8 md:px-10 md:pb-10 lg:grid-cols-4">
        <div className="flex flex-col items-center mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              Thank you very much and thank you for your valuable feedback. The
              bitter experience you had with the delivery man is truly
              unfortunate and we apologize. I hope that the will give importance
              to these issues and work to make the service chief faster.
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
        ...
        <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              Received my laptop today. This is my first purchase from laptop
              city. Everything is fine as I wanted. Seller is very sincere and
              helpful. . Laptop city also called repeatedly asking if the
              product is ok. I like Laptop City Service. In one word, 100%
              Satisfied. Highly recommend this store.
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
